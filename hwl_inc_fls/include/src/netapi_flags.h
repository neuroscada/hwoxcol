/************************************************************************/
/*****     COPYRIGHT 2008 - 2013    HONEYWELL INTERNATIONAL SARL     ****/
/************************************************************************/

/* Conditionally print out a trace of header file activity */
#ifdef _HEADER_FILE_TRACE_FLAG
#pragma message("Entering Header file: netapi_flags.h")
#endif
...
#pragma message("ERROR: Partially processed: netapi_flags.h")
#else
#define NETAPI_FLAGS_STARTFLAG

/*
@(#)netapi_flags.h	main.SVR_MASTERPROJ_Integration.4
BEGIN_DOC
---------------------------------------------------------------------------
...
#define NADS_VERS_UNKNOWN   0   // Used to mark that the NADS version of a host is unknown
#define	NADS_VERS1      1
#define NADS_VERS2      2	// Add support for >65K (32 bit) point numbers
...
#define HSC_C_FALLBACK_SUCCESS  2
...
#define NIF_SERVER_NAME_WRITE   "hsc_nif_write"

#define NIF_SERVER_PROTOCOL         "udp"
#define NIF_SERVER_PORT             50000
#define NIF_SERVER_PORT_WRITE		50001

#define NIF_SERVER_PROTOCOL_TCP     "tcp"
#define NIF_SERVER_PORT_TCP         22479
#define NIF_SERVER_PORT_WRITE_TCP   22480
...
#define NIF_POINT_NUMBERS_2_FUNC_NO	41
#define NIF_PARAM_NUMBERS_2_FUNC_NO	42
#define NIF_PARAM_VALUES_2_FUNC_NO	43
#define NIF_PARAM_VALUE_PUTS_2_FUNC_NO	44
#define NIF_PARAM_VALUE_PUTS_SEC_2_FUNC_NO	45
#define NIF_PARAM_HIST_DATES_2_FUNC_NO	46
#define NIF_PARAM_HIST_OFFSETS_2_FUNC_NO	47
#define NUM_NIFD_NAMES 47	/* Update this to the last function number */
...
#define NADS_READS_DISABLED     0x83A3  /* NetAPI Reads are disabled */
#define NADS_WRITES_DISABLED    0x83A4  /* NetAPI Writes are disabled */
#define NADS_WRONG_PORT         0x83A5  /* Return if a write recieved on read port */
#define NADS_AUTHORISATION_FAIL 0x83A6  /* For TCP clients, user does not have correct SOR */
...
#define FALLBACK_USED       1
#define FALLBACK_NOT_USED   0

#define NADS_VERS_1_CALL_MODE           1
#define NADS_VERS_2_CALL_MODE           2
#define FALLBACK_NADS_VER_1_CALL_MODE   3   // Falling back to NADS version 1 from version 2
...
/* Conditionally print out a trace of header file activity */
#ifdef _HEADER_FILE_TRACE_FLAG
#pragma message("Leaving Header file: netapi_flags.h")
#endif
