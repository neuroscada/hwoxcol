...
#pragma message("Entering Header file: netapi_types.h")
#endif
...
#pragma message("ERROR: Partially processed: netapi_types.h")
#else
#define NETAPI_TYPES_STARTFLAG

/*
@(#)netapi_types.h	main.SVR_MASTERPROJ_Integration.1
BEGIN_DOC
---------------------------------------------------------------------------
...
{
    n_ushort        hist_type;          /* (in) History type */
    n_ulong         hist_start_date;    /* (in) Starting Date */
    n_float         hist_start_time;    /* (in) Starting Time */
    n_ushort        num_hist;           /* (in) Number of history values for each point */
    n_ushort        num_points;         /* (in) Number of pnt prm pairs */
    n_ushort        *point_type_nums;   /* (in) Array of Point Numbers */
    n_ushort        *point_params;      /* (in) Array of Parameter Numbers */
    n_char          *archive_path;      /* (in) Archive Path */
    n_float         *hist_values;       /* (out) Array of history values returned */
    n_ushort        gethst_status;      /* (out) Status of server function c_gethstpar_date */
} rgethstpar_date_data;

typedef struct rgethstpar_date_data_str_2
{
    n_ushort        hist_type;          /* (in) History type */
    n_ulong         hist_start_date;    /* (in) Starting Date */
    n_float         hist_start_time;    /* (in) Starting Time */
    n_ushort        num_hist;           /* (in) Number of history values for each point */
    n_ushort        num_points;         /* (in) Number of pnt prm pairs */
    n_ulong         *point_type_nums;   /* (in) Array of Point Numbers */
    n_ushort        *point_params;      /* (in) Array of Parameter Numbers */
    n_char          *archive_path;      /* (in) Archive Path */
    n_float         *hist_values;       /* (out) Array of history values returned */
    n_ushort        gethst_status;      /* (out) Status of server function c_gethstpar_date */
} rgethstpar_date_data_2;
...
{
    n_ushort        hist_type;          /* (in) History type */
    n_ushort        hist_offset;        /* (in) Number of history offsets */
    n_ushort        num_hist;           /* (in) Number of history values for each point */
    n_ushort        num_points;         /* (in) Number of pnt prm pairs */
    n_ushort        *point_type_nums;   /* (in) Array of Point Numbers */
    n_ushort        *point_params;      /* (in) Array of Parameter Numbers */
    n_char          *archive_path;      /* (in) Archive Path */
    n_float         *hist_values;       /* (out) Array of history values returned */
    n_ushort        gethst_status;      /* (out) Status of server function c_gethstpar_ofst */
} rgethstpar_ofst_data;

typedef struct rgethstpar_ofst_data_str_2
{
    n_ushort        hist_type;          /* (in) History type */
    n_ushort        hist_offset;        /* (in) Number of history offsets */
    n_ushort        num_hist;           /* (in) Number of history values for each point */
...
/* Structure used by rhsc_point_numbers()*
 * 32bit point number version */
typedef struct _POINT_NUMBER_DATA_2
{
    n_char      *szPntName; /* (in) point name to resolve */
    n_ulong     nPnt;       /* (out) point number */
    n_long      fStatus;    /* (out) status of each request. */
} POINT_NUMBER_DATA_2;
...
/* Structure used by rhsc_param_numbers() */
/* 32bit point number version */
typedef struct _PARAM_NUMBER_DATA_2
{
    n_ulong     nPnt;       /* (in) point number*/
    n_char      *szPrmName; /* (in) parameter name to resolve */
    n_ushort    nPrm;       /* (out) parameter number returned */
    n_long      fStatus;    /* (out) status of each request. */
} PARAM_NUMBER_DATA_2;
...
/* 
Same as PARAM_VALUE_DATA but using 32bit point numbers.
*/
typedef struct _PARAM_VALUE_DATA_2
{
    n_ulong     nPnt;      /* (in) point number */
    n_ushort    nPrm;       /* (in) parameter number */
    n_long      nPrmOffset; /* (in)point parameter offset */
...
/* Function arguments used during fallback from NADS v1 -> v2 */
typedef struct _RHSC_POINT_NUMBERS_2_ARGS
{
    char                    *szHostname;
    int                     cpntnd;
    POINT_NUMBER_DATA_2     *rgpntnd2;
} RHSC_POINT_NUMBERS_2_ARGS;

typedef struct _RHSC_PARAM_NUMBERS_2_ARGS
{
    char                    *szHostname;
    int                     cprmnd;
    PARAM_NUMBER_DATA_2     *rgprmnd2;
} RHSC_PARAM_NUMBERS_2_ARGS;

typedef struct _RHSC_PARAM_VALUES_2_ARGS
{
    char                    *szHostname;
    int                     nPeriod;
    int                     cprmvd;
    PARAM_VALUE_DATA_2      *rgprmvd2;
} RHSC_PARAM_VALUES_2_ARGS;

typedef struct _RHSC_PARAM_VALUE_PUTS_2_ARGS
{
    char                    *szHostname;
    int                     cprmvd;
    PARAM_VALUE_DATA_2      *rgprmvd2;
} RHSC_PARAM_VALUE_PUTS_2_ARGS;

typedef struct _RHSC_PARAM_VALUE_PUTS_SEC_2_ARGS
{
    char                    *szHostname;
    int                     cprmvd;
    PARAM_VALUE_DATA_2      *rgprmvd2;
    unsigned short          nStn;
} RHSC_PARAM_VALUE_PUTS_SEC_2_ARGS;

typedef struct _RHSC_PARAM_HIST_DATES_2_ARGS
{
    char                    *szHostname;
    int                     num_gethsts;
    rgethstpar_date_data_2  *gethstpar_date_data2;
} RHSC_PARAM_HIST_DATES_2_ARGS;

typedef struct _RHSC_PARAM_HIST_OFFSETS_2_ARGS
{
    char                    *szHostname;
    int                     num_gethsts;
    rgethstpar_ofst_data_2  *gethstpar_ofst_data2;
} RHSC_PARAM_HIST_OFFSETS_2_ARGS;
...
/* Conditionally print out a trace of header file activity */
#ifdef _HEADER_FILE_TRACE_FLAG
#pragma message("Leaving Header file: netapi_types.h")
#endif
